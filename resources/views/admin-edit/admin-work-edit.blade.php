...
@section('content')
    <h1 class="text-3xl font-bold mb-6">楽曲編集: {{ $work->title }}</h1>

    <div class="bg-white p-6 rounded-lg shadow-md">
        <form action="{{ route('admin-works.update', $work) }}" method="POST">
            @csrf
            @method('PUT') {{-- 編集にはPUTメソッドが必要 --}}
            ...
            <div class="mb-4">
                ...
                <input type="text" name="composer" id="composer" value="{{ old('composer', $work->composer) }}"
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('composer')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="arranger" id="arranger" value="{{ old('arranger', $work->arranger) }}"
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('arranger')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="date" id="date" value="{{ old('date', $work->date) }}"
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('date')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="place" id="place" value="{{ old('place', $work->place) }}"
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('place')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <input type="text" name="artist" id="artist" value="{{ old('artist', $work->artist) }}"
                      class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                @error('artist')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            ...
            <div class="mb-4">
                ...
                <textarea name="comment" id="comment" rows="5"
                          class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">{{ old('comment', $work->comment) }}</textarea>
                @error('comment')
                    <p class="text-red-500 text-xs italic">{{ $message }}</p>
                @enderror
            </div>
